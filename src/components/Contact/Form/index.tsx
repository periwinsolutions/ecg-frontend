              ...
              <div className="mt-8 p-6 bg-gray-50 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
                ...
                <ul className="space-y-3">
                  <li className="flex items-center gap-3">
                    ...
                    <span className="text-gray-600 dark:text-gray-400 text-sm">hello@example.com</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <li className="flex items-center gap-3">
                    ...
                    <span className="text-gray-600 dark:text-gray-400 text-sm">123 Main St, London, UK</span>
                  </li>
                </ul>
              </div>
            </div>
